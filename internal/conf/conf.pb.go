...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x05trace\x18\x06 \x01(\v2\x11.kratos.api.TraceR\x05trace\"7\n" +
	"\aService\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\"\x19\n" +
	"\x03Env\x12\x12\n" +
	"\x04mode\x18\x01 \x01(\tR\x04mode\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x87\x03\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x1a\xdd\x01\n" +
	"\x05Redis\x12\x12\n" +
	...
	"\x05Trace\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpointB\"Z sgn-layout-v2/internal/conf;confb\x06proto3"
