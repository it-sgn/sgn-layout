...
.PHONY: initProject
initProject:
# Initialize the project and change package to project, that is module github.com/ZQCard/$(PROJECT)
...
# Replace Example $(ServiceUpperName), example with $(ServiceLowerName) and migrate the files
